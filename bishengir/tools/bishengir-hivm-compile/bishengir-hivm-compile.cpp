...
static void printVersion(llvm::raw_ostream &os) {
  os << bishengir::getBiShengIRToolFullVersion("bishengir-hivm-compile") << '\n';
}
...
void registerAndParseCLIOptions(int argc, char **argv) {
  ...
  bishengir::BiShengIRHIVMCompileMainConfig::registerCLOptions();
...
int main(int argc, char **argv) {
  ...
  bishengir::BiShengIRHIVMCompileMainConfig config =
      bishengir::BiShengIRHIVMCompileMainConfig::createFromCLOptions();
  ...
  auto hivmResult = bishengir::runBiShengIRHIVMPipeline(module, config);
  if (failed(hivmResult)) {
