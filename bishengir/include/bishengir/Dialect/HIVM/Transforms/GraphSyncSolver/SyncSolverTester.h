...
//
//===----------------------------------------------------------------------===//
#ifndef BISHENG_DIALECT_HIVM_GRAPHSYNCSOLVER_SYNCSOLVERTESTER_H
#define BISHENG_DIALECT_HIVM_GRAPHSYNCSOLVER_SYNCSOLVERTESTER_H
...
#endif // BISHENG_DIALECT_HIVM_GRAPHSYNCSOLVER_SYNCSOLVERTESTER_H
