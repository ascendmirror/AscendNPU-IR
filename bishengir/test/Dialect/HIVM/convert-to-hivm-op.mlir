...
func.func @test_load_with_mask_other_memref_collapse_shape(
  ...
  // CHECK: hivm.hir.load ins(%subview : memref<?xi64, strided<[1], offset: ?>>) outs(%subview_0 : memref<?xi64, strided<[1], offset: ?>>) pad_mode = <PadValue> pad_value = %c-1_i64 : i64 init_out_buffer = true init_condition = %arg2 : i1 may_implicit_transpose_with_last_axis = false
  memref.copy %subview, %subview_0 : memref<?xi64, strided<[1], offset: ?>> to memref<?xi64, strided<[1], offset: ?>>
...
func.func @test_load_with_mask_other_memref_expand_shape(
  ...
  // CHECK: hivm.hir.load ins(%subview : memref<?x1xi64, strided<[1, 1], offset: ?>>) outs(%subview_0 : memref<?x1xi64, strided<[1, 1], offset: ?>>) pad_mode = <PadValue> pad_value = %c-1_i64 : i64 left_padding_num = %c0 : index init_out_buffer = true init_conditon = %arg2 : i1 may_implicit_transpose_with_last_axis = false
