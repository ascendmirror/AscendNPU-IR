...
// CHECK-LABEL: test_cube_load_subview
...
// CHECK-CUBE: scf.for
// CHECK-CUBE: scf.for
// CHECK-CUBE-SAME: %[[c0]] to %[[c256]] step %[[c64]]
// CHECK-CUBE: hivm.hir.load
module attributes {dlti.target_system_spec = #dlti.target_system_spec<"NPU" : #hacc.target_device_spec<#dlti.dl_entry<"L0C_SIZE", 1048576 : i32>, #dlti.dl_entry<"UB_ALIGN_SIZE", 256 : i32>>>} {
  func.func @test_cube_load_subview(%arg0: memref<256x192xbf16>, %arg1: memref<256x192xbf16>, %arg2: memref<2x256x256xf32>, %arg3: index, %arg4: index, %arg5: index, %arg6: index) {
    %c1 = arith.constant 1 : index
    %true = arith.constant true
    %c0 = arith.constant 0 : index
