...
// CHECK: %extracted = tensor.extract {{.*}} : tensor<1x1xf16>
...
// CHECK: %extracted = tensor.extract {{.*}} : tensor<1x1xi32>
// CHECK: %[[INSERTED:.*]] = tensor.insert %[[VAL:.*]] into %arg0[%c0, %c0] : tensor<32x32xi32>
func.func @test_expanded_insert_slice(%arg0: tensor<32x32xi32>, %arg1: index, %arg2: index) -> tensor<32x32xi32>{
  %c0 = arith.constant 0 : index
