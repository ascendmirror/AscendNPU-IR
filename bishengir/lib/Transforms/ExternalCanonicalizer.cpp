...
void getLinalgCanonicalizationPatterns(RewritePatternSet &results) {
...
struct ExternalCanonicalizer
  ...
  LogicalResult initialize(MLIRContext *context) final {
    ...
    getLinalgCanonicalizationPatterns(patterns);
...
std::unique_ptr<mlir::Pass> bishengir::createExternalCanonicalizerPass(
