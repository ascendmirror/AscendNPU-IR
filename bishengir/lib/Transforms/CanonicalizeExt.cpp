...
struct ExternalCanonicalizer
  ...
  LogicalResult initialize(MLIRContext *context) final {
    ...
    patterns.add<NormalizeBroadcastDenseSplatToFillConstant, FoldBroadcastFill>(
        context);
    patterns.add<MergeConsecutiveReduceOp>(context);
    patterns.add<linalg::RefactorRedundantReduceLikeOp<linalg::ReduceOp>>(
        context);
    patterns.add<FoldTransposeWithExpand>(context);
    patterns
        .add<linalg::SimplifySplatDenseForBinary<linalg::ElemwiseBinaryOp>,
