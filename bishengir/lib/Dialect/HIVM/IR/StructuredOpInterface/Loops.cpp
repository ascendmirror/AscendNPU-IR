...
ENABLE_NO_DEFAULT_GET_ITERATOR_TYPES_ARRAY(LoadL0AOp)
ENABLE_NO_DEFAULT_GET_ITERATOR_TYPES_ARRAY(LoadL0BOp)
ENABLE_NO_DEFAULT_GET_ITERATOR_TYPES_ARRAY(LoadMatMulBiasOp)
...
SmallVector<hivm::IteratorType> MmadL0Op::getIteratorTypesArray() {
  auto cLayoutAttr = getOperandCLayout();
  if (failed(cLayoutAttr))
    return {hivm::IteratorType::kOpaque};
