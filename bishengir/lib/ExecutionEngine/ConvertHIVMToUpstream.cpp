...
struct RewriteElemwiseOp final : public GenericPreprocessAndRewrite<From> {
  ...
  static_assert(
      ...
      "The provided elemwise operations is not allowed.");
  static_assert(!std::is_same_v<EquivalentFnAttr, void> ||
                    std::is_same_v<decltype(equivalentFn),
                                   typename EquivalentFnAttr::ValueType>,
                "The provided elemwise function for the newly created "
